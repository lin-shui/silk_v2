...
// ── cc-connect → silk (generated images) ──

/**
 * Sent by cc-connect after a turn completes, carrying base64-encoded images
 * that were generated by the agent during the turn (e.g. PNG/SVG from tools).
 * The [images] field reuses the same [ImageAttachment] structure as the
 * inbound [UserMessage].
 */
@Serializable
data class ReplyImagesMessage(
    val type: String = "reply_images",
