...
# 本机 `python -m http.server` 与浏览器访问口一致。旧逻辑用 FRONTEND_INTERNAL_PORT 覆盖
# 监听口，若与 FRONTEND_HTTP_PORT 不同且无反向代理，会出现「提示 15004 实际在 18005」无法打开。
FRONTEND_PORT=$FRONTEND_HTTP_PORT
